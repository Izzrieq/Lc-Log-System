                                ...
                                <div class="personal w-full">
                                    ...
                                    <div class='w-full md:w-full px-3 mb-3'>
                                        ...
                                        <textarea name="address" type="text"
                                            class='appearance-none block w-full bg-white text-gray-700 text-xs border border-gray-400 shadow-inner rounded-md py-3 px-2 leading-tight focus:outline-none focus:border-gray-500'><?php echo $address; ?>
                                        </textarea>
                                    </div>
                                    <div class="flex items-center justify-between mt-2">
