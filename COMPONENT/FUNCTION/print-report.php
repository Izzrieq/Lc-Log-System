...
<body>
    <center>
                <form class="mt-20" action="print-selection.php" method="post">
                    <table class="border border-gray-700 w-fit sm:px-6 lg:px-8">
                        ...
                        <tbody class="text-center">
                            ...
                            <tr>
                                <td class="px-3 py-4">
                                    <label for="bulan"
                                        class="block uppercase text-blueGray-600 text-lg font-bold mb-0">Date
                                        <select name="bulan"
                            ...
                            <tr>
                                <td class="px-6 py-4">
                                    <label for="pilihan"
                                        class="block uppercase text-blueGray-600 text-lg font-bold mb-0">Type
                                        <select name="pilihan"
                            ...
                            <tr>
                                <td>
                            <button class="w-full bg-blue-400 border-t border-gray-700" style="background-image: url(image/printer-icon.png);" type="submit">Papar</button>
                            </td></tr>
                        </tbody>
                    </table>      
                </form>
