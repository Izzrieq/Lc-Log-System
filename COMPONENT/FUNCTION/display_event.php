...
$display_query = "select event_id,event_name,event_start_date,event_end_date,department,user_id from events";             
...
if($count>0) 
{
	...
	$data_arr[$i]['department'] = $data_row['department'];
	$data_arr[$i]['user_id'] = $data_row['user_id'];
