                            ...
                            <tr>
                                ...
                                <td class="border-r border-b p-2">
                                    <div class="flex items-center justify-between mt-2">
                                        <button
                                            class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-2 border border-gray-700 rounded">
                                            <a href='tlcp-info.php?id=<?php echo $r['id'];?>'>INFO</a>
                                        </button>
                                        <button
                                            class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 border border-gray-700 rounded">
